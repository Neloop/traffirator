...
public class TravellingManagerScenario extends Scenario {
    ...
    private static void init() throws Exception {
        ...
        ScenarioNode callInit = new NodeBuilder()
                ...
                .addSendAction(new RxAar_Noop_SendAction())
        ...
        connect.addChild(50, 30_000, update)
                .addChild(10, 360_000, disconnect)
                .addChild(10, 360_000, lostConnection)
                .addChild(30, 120_000, callInit)
                .validateProbabilities();
        update.addChild(30, 30_000, update)
                .addChild(10, 360_000, disconnect)
                .addChild(10, 360_000, lostConnection)
        ...
        callInit.addChild(50, 6_000, callUpdate)
                ...
                .addChild(10, 120_000, callTermination)
                .addChild(20, 6_000, callLostConnection)
                .validateProbabilities();
        callUpdate.addChild(60, 30_000, callUpdate)
                .addChild(20, 6_000, callUpdateCodec)
                .addChild(20, 60_000, callTermination)
                .validateProbabilities();
        callUpdateCodec.addChild(20, 6_000, callUpdateCodec)
                .addChild(40, 30_000, callUpdate)
                .addChild(20, 120_000, callTermination)
                .addChild(20, 6_000, callLostConnection)
                .validateProbabilities();
        callTermination.addChild(20, 120_000, callInit)
                .addChild(60, 30_000, update)
